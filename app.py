...
# 2. THE ULTIMATE CSS (RE-ESTABLISHED LARGE UI)
st.markdown("""
    <style>
    ...
    /* Section Styling */
    .section-label { color: #00F0FF; font-size: 14px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 8px; margin-top: 30px; }
    .how-to { color: #484F58; font-size: 13px; margin-top: -5px; margin-bottom: 25px; font-style: italic; }

    /* FORCING METRICS TO BE LARGE & CENTERED */
...
# 5. STATE LOGIC (PREVENTS INDEX ERROR)
...
# LARGE CENTERED METRICS WITH REAL TOOLTIPS
st.markdown("---")
m1, m2 = st.columns(2)
with m1:
    st.metric("Simulated Risk", f"{sim_risk:.1f}%", help="Predicted churn probability after simulation.")
with m2:
    st.metric("Revenue Safeguarded", f"+${savings:,.2f}", help="Revenue protected by reducing risk.")
